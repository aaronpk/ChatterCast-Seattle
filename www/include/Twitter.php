...
class Twitter {
	...
	public function oauth($consumer_key, $consumer_secret, $access_token = NULL, $access_token_secret = NULL)
	{
		...
		{
			// Authenticate URL will seamlessly send the user back if the app is already approved
			//$url = $this->oauth->getAuthenticateUrl();
			// Authorize URL makes the user approve the app every time
